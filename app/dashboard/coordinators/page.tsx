...
type CoordinatorItem = { id: string; name: string; email: string };
  ...
  return (
    <div className="min-h-screen bg-parchment">
      <header className="border-b-2 border-gold bg-navy px-8 py-5">
        <h1 className="mx-auto max-w-3xl font-display text-2xl tracking-wide text-parchment">Coordinators</h1>
      </header>
      ...
      <main className="mx-auto max-w-3xl px-8 py-10">
        ...
        <p className="mb-3 text-xs font-semibold uppercase tracking-widest text-navy/50">All Coordinators</p>
